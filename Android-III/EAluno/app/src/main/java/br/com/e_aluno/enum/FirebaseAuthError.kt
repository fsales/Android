package br.com.e_aluno.enum

import com.google.firebase.auth.FirebaseAuthException

enum class FirebaseAuthError private constructor(val description: String) {
    ...
    companion object {
        ...
        /**
         * Get an [FirebaseAuthError] from an exception, returning [.ERROR_UNKNOWN] as
         * a default.
         */
        fun fromException(ex: FirebaseAuthException): FirebaseAuthError {
            try {
                return FirebaseAuthError.valueOf(ex.errorCode)
